...
function getEnglishPages(): SitePage[] {
  return [
    ...
    { path: '/en/contact/', title: 'Advertising | TarotMind', description: 'Advertising inquiries and contact information for TarotMind.', locale: 'en', lastmod: DEFAULT_LASTMOD, changefreq: 'yearly', priority: 0.2 }
  ];
}
