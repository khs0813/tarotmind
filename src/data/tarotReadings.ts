...
export const tarotReadings: TarotReadingPage[] = [
  {
    slug: 'today',
    title: '오늘의 타로 | 하루 운세와 조언을 보는 무료 타로 리딩',
    shortTitle: '오늘의 타로',
    description: '오늘의 타로로 하루의 흐름, 조언, 주의할 점을 카드 한 장으로 확인하세요. 간단하고 부담 없이 이용할 수 있는 무료 타로 리딩입니다.',
    category: 'daily',
    spreadType: 'one-card',
  ...
  {
    slug: 'love',
    title: '연애 타로 | 상대방 마음과 사랑의 흐름을 보는 무료 타로',
    shortTitle: '연애 타로',
    description: '연애 타로로 현재 관계의 흐름, 상대방의 마음, 앞으로의 조언을 확인해 보세요. 사랑 고민에 맞춘 무료 타로 리딩입니다.',
    category: 'love',
  ...
  {
    slug: 'reunion',
    title: '재회 타로 | 다시 만날 가능성과 관계의 흐름 해석',
    shortTitle: '재회 타로',
    description: '재회 타로로 이별 후 상대방의 마음, 다시 연락할 가능성, 관계 회복을 위한 조언을 확인해 보세요.',
    category: 'love',
    spreadType: 'three-card',
  ...
  {
    slug: 'career',
    title: '직장운 타로 | 일, 이직, 커리어 고민을 위한 무료 타로',
    shortTitle: '직장운 타로',
    description: '직장운 타로로 현재 업무 흐름, 이직 고민, 커리어 방향, 일에서 주의할 점을 확인해 보세요.',
    category: 'career',
    spreadType: 'three-card',
  ...
  {
    slug: 'money',
    title: '금전운 타로 | 돈, 소비, 투자 흐름을 보는 무료 타로',
    shortTitle: '금전운 타로',
    description: '금전운 타로로 현재 재정 흐름, 소비 습관, 돈과 관련된 선택에서 참고할 조언을 확인해 보세요.',
    category: 'money',
    spreadType: 'three-card',
  ...
  {
    slug: 'yes-or-no',
    title: 'Yes or No 타로 | 예/아니오 고민을 위한 간단한 타로 리딩',
    shortTitle: 'Yes or No 타로',
    description: '선택이 필요한 질문에 대해 Yes or No 타로로 간단한 방향성을 확인해 보세요. 빠르게 뽑아보는 무료 타로 리딩입니다.',
    category: 'choice',
    spreadType: 'yes-no',
  ...
  {
    slug: 'three-card',
    title: '3장 타로 | 과거·현재·미래 흐름을 보는 무료 타로',
    shortTitle: '3장 타로',
    description: '3장 타로로 과거, 현재, 미래의 흐름을 한 번에 살펴보세요. 관계, 일, 선택 고민에 활용할 수 있는 무료 타로 리딩입니다.',
    category: 'daily',
    spreadType: 'three-card',
